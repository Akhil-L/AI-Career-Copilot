      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-4">
                <div className="bg-slate-50 p-4 rounded-lg border">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {task.dataFields.map(f => (
                      <span key={f} className="bg-white border px-2 py-1 rounded text-sm font-mono">{f}</span>
                    ))}
                  </div>
                </div>
                ...
                {task.status === 'submitted' && (
                  <Alert>
                    ...
                    <AlertDescription>Your submission is being reviewed by the admin.</AlertDescription>
                  </Alert>
                )}
              </CardContent>
            </Card>
          ...
          <div className="md:col-span-1">
            <Card className={!canSubmit ? "opacity-60 grayscale" : "border-primary shadow-lg"}>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div 
                  className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${file ? 'border-primary bg-primary/5' : 'border-slate-200'}`}
